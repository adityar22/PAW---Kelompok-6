const ModalConfirm = () => {
    return (
        <>
            ...
            <div className="container w-fit mx-auto absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 hover:scale-105 transition-all duration-700">
                <div className="relative bg-white rounded-lg shadow-lg">
                    ...
                    <div className="p-6 text-center">
                        ...
                        <button data-modal-toggle="popup-modal" type="button" className="text-white bg-red-500 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                            Yes, I'm sure
                        </button>
