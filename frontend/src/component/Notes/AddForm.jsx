...
const AddForm = ({ openAddPopup, closeAddPopup, setLoading, url, setError, notify }) => {
    ...
    const { handleAdd: handleSubmit } = useHandleAdd({ url, type: 'ADD_NOTES', dispatch, data: newTodos, setLoading, setError, notify, closeAddPopup});
            ...
            <div className="container w-fit mx-auto fixed z-30 mt-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 sm:hover:scale-105 transition-all duration-700">
                <form className="create w-screen max-w-xl mx-8 bg-white shadow-xl rounded-lg px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
                    <div className="flex flex-row justify-between mb-12">
                        ...
                        <button onClick={closeAddPopup} type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex items-center ml-4" data-modal-toggle="staticModal">
